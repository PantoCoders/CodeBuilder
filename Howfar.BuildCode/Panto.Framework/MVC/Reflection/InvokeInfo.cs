...
namespace Panto.Framework.MVC
{
	...
	internal sealed class InvokeInfo
	{
        ...
        public LogAttribute GetLogAttribute()
        {
            if (this.Action != null && this.Action.LogAttr != null)
                return this.Action.LogAttr;
            if (this.Controller != null && this.Controller.LogAttr != null)
                return this.Controller.LogAttr;
            return null;
        }
	}
